defmodule ChatbotWeb.ChatbotLive.FormComponent do
  use ChatbotWeb, :live_component
  ...
  def update(%{message: message} = assigns, socket) do
    changeset = Bot.change_message(message)
  ...
  def handle_event("save", %{"message" => message_params}, socket) do
    ...
    case Bot.create_message(socket.assigns.conversation, message_params) do
      {:ok, message} ->
